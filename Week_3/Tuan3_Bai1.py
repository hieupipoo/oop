class ConCho:
    def __init__(self, ten, mau_sac, giong, cam_xuc="vui"):
        self.ten      = ten
...
cho = ConCho("Kiki", "vàng", "Golden Retriever")
cho.sua(); cho.an("xương")

xe = OTo("Audi", "sedan", "trắng", 800_000_000)
xe.tang_toc(60); xe.tang_toc(40); xe.giam_toc(30)

tk = TaiKhoan("Tran Van A", "123456789", "Vietcombank", 5_000_000)
